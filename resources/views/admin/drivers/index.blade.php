    ...
    <div class="tab-content">
        ...
        <div class="tab-pane active fade in" id="inside">
            ...
            <div class="panel panel-default">
                <div class="panel-heading"><h6 class="panel-title"><i class="icon-file"></i>{{ trans('cruds.driver.title_singular') }} {{ trans('global.list') }}</h6></div>
                <div class="datatable">
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <!-- <th>{{ trans('cruds.driver.fields.email_verified_at') }}</th> -->
                                <th>{{ trans('cruds.driver.fields.roles') }}</th>
                                <th>&nbsp;</th>
                            </tr>
                        </thead>
                        <tbody>
                        ...
                        @foreach($drivers as $key => $user)
                            <tr data-entry-id="{{ $user->id }}">
                                ...
                                <td>
                                    @can('user_show')
                                        <a class="btn btn-xs btn-primary" href="{{ route('admin.drivers.show', $user->id) }}">
                                            {{ trans('global.view') }}
                                        </a>
                                    @endcan
            ...
            <table class=" table table-striped table-hover datatable datatable-User">
                <thead>
                    <tr>
                        ...
                        <th>
                            {{ trans('cruds.driver.fields.roles') }}
                        </th>
                        <th>
                            &nbsp;
                        </th>
