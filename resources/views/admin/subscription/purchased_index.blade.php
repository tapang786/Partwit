                        ...
                        <tr data-entry-id="{{ $payment->id }}">
                            ...
                            <td>
                                ...
                                {{-- @can('subscription_edit')
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.subscription.edit', $payment->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan

                                @can('subscription_delete')
                                    <form action="{{ route('admin.subscription.destroy', $payment->id) }}" method="POST" onsubmit="return confirm('{{ trans('global.areYouSure') }}');" style="display: inline-block;">
