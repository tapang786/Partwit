...
class PaymentsController extends Controller
{
    ...
    public function index()
    {
        ...
        $payments = Payments::leftJoin('users','users.id','=','payments.user_id')
                                ->leftJoin('user_subscription','user_subscription.id','=','payments.subscription_id')
                                ->select('payments.*', 'users.name as user_name', 'user_subscription.title as subscription')
                                ->get();
